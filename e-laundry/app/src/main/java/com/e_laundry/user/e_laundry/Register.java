...
public class Register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_register = (Button) findViewById(R.id.bSignUp);
        txt_username = (EditText) findViewById(R.id.inName);
        txt_password = (EditText) findViewById(R.id.inPass);
        txt_confirm_password = (EditText) findViewById(R.id.inConfirm);
    ...
    private void checkRegister(final String username, final String password, final String confirm_password) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("repassword", confirm_password);
